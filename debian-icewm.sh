# Install packages
sudo apt install packaging-dev build-essential automake autoconf efibootmgr firmware-iwlwifi python3 python3-pip x11-xserver-utils xorg git sudo bpytop vim ranger htop cmus mpv geany meld lightdm openbox icewm rox-filer pcmanfm rxvt-unicode nala xterm feh picom neofetch connman connman-gtk lxpolkit unzip pipewire pipewire-pulse pipewire-jack pipewire-alsa wireplumber pipewire-media-session- libspa-0.2-bluetooth pavucontrol arandr lxappearance flameshot gdebi synaptic lsd bat numlockx openssh-server p7zip-full ufw gufw network-manager magnus firefox-esr chromium libreoffice libreoffice-gtk3 emacs abiword gimp transmission transmission-cli transmission-common transmission-gtk handbrake audacity hexchat gparted rofi timeshift evince keepassxc inkscape darktable krita blueman galculator vlc fontforge i3lock redshift conky-all lm-sensors alacritty nitrogen l3afpad xfburn mirage celluloid fish audacious acpi acpi-support apt-show-versions cherrytree claws-mail aspell aspell-el aspell-en cups cups-common cups-core-drivers cups-ppdc cups-filters xournal dosbox  gtk-theme-switch gtk2-engines arc-theme papirus-icon-theme ttf-mscorefonts-installer fonts-noto-color-emoji fonts-crosextra-carlito fonts-crosextra-caladea fonts-powerline fonts-font-awesome fonts-ubuntu fonts-ubuntu-console fonts-liberation2 fonts-terminus -y
